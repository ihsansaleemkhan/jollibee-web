					...
					<div class="col-sm-4 fd_item">
						...
						<div class="row">
							...
							<div class="hover-area">
				                <button data-toggle="modal" data-target="#exampleModalCenter"  rel="nofollow" data-quantity="1" data-product_id="51" data-product_sku="" class="button product_type_simple add_to_cart_button ajax_add_to_cart">Add to cart</button>
				            </div>
						</div>
					</div>
					@endforeach

...
class PaypalController extends Controller
{
    ...
    public function expressCheckoutSuccess(Request $request) {
        ...
        if ($invoice->paid) {
            return redirect('order-received')->with(['code' => 'success', 'message' => 'Order ' . $invoice->id . ' has been paid successfully!']);
        }

        return redirect('order-received')->with(['code' => 'danger', 'message' => 'Error processing PayPal payment for Order ' . $invoice->id . '!']);
    }
